# Generated by Django 3.2.18 on 2023-03-21 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления публикации')),
                ('authors', models.ManyToManyField(related_name='blogs', to=settings.AUTH_USER_MODEL, verbose_name='Автор публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default='1000-01-01', verbose_name='Дата публикации')),
                ...
                ('tags', models.ManyToManyField(related_name='posts', to='api.Blog', verbose_name='Тэги постов')),
            ],
            options={
                'verbose_name': 'Пост',
